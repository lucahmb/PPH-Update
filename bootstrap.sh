...
CHANNEL_URL="https://raw.githubusercontent.com/lucahmb/PPH-Update/main/channels/stable.json"
...
url=sys.argv[1]
req=urllib.request.Request(url, headers={'User-Agent':'PPH-Bootstrap/1'})
